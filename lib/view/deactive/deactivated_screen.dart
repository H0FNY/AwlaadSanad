...
class DeactivatedStudents extends StatefulWidget {
  DeactivatedStudents();
  @override
  _DeactivatedStudentsState createState() => _DeactivatedStudentsState();
}

class _DeactivatedStudentsState extends State<DeactivatedStudents> {
  String mon = "";
  ...
  Future<void> _refreshData(BuildContext context) async {
    await context.read<SearchStudentCubit>().fetchDeactivatedStudents(month,daysOnMonth.length);
  }
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                con.read<SearchStudentCubit>().deleteStudent(id, month,daysOnMonth.length);
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => SearchStudentCubit()..fetchDeactivatedStudents(month,daysOnMonth.length),
        ...
        listener: (context, state) async {
          ...
          if (state is SearchStudentFailure) {
            ...
            await context
                ...
                .fetchDeactivatedStudents( month,daysOnMonth.length);
          }
        },
