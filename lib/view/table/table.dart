...
import 'package:awladsanaad_2/model/group_model.dart';
import 'package:awladsanaad_2/model/student_model.dart';
import 'package:awladsanaad_2/view/table/table_cubit.dart';
...
class _tableState extends State<table> {
  ...
  Future<void> _pickDate(BuildContext con) async {
    ...
    if (pickedDate != null) {
      ...
      await con.read<TableCubit>().fetchAttendance(widget.groupId, month,daysOnMonth.length);
    }
  }
  ...
  void _showAddDialog(BuildContext con) {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (studentNameController.text.isNotEmpty) {
                  con.read<TableCubit>().addStudent(studentNameController.text, widget.groupId, month,daysOnMonth.length,studentPhoneController.text);
                  Navigator.of(context).pop();
                  setState(() {});
                } else {
                  Navigator.of(context).pop();
  ...
  void _showUpdateDialog(BuildContext con, StudentModel std,double width)async {
    Group? selectedValue;
    final response = await GroupService().getAllGroups();
    final List<dynamic> jsonResponse = json.decode(response.body);
    final groups = jsonResponse
        .map((data) => Group.fromJson(data))
        .toList();
    final TextEditingController studentNameController = TextEditingController();
    studentNameController.text=std.name;
    final TextEditingController studentPhoneController = TextEditingController();
    studentPhoneController.text=std.phoneNumber;
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              DropdownButtonFormField(
                ...
                items:
                groups.map<DropdownMenuItem<Group>>((Group value) {
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (studentNameController.text.isNotEmpty&&studentPhoneController.text.isNotEmpty) {
                  con.read<TableCubit>().updateStudent(studentNameController.text, widget.groupId, selectedValue?.id??null, month,daysOnMonth.length,studentPhoneController.text,std.id);
                  Navigator.of(context).pop();
                  setState(() {});
                } else {
                  Navigator.of(context).pop();
  ...
  void _showcommentDialog(BuildContext con,int id) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                con.read<TableCubit>().deactivate(id, widget.groupId, month,daysOnMonth.length);
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  Future<void> _refreshData(BuildContext context) async {
    await context.read<TableCubit>().fetchAttendance(widget.groupId, month,daysOnMonth.length);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => TableCubit()..fetchAttendance(widget.groupId, month,daysOnMonth.length),
      child: BlocConsumer<TableCubit, TableState>(
        listener: (context, state) async {
          ...
          if (state is TableFailure) {
            ...
            await context
                .read<TableCubit>()
                .fetchAttendance(widget.groupId, month,daysOnMonth.length);
          }
        },
              ...
              appBar: AppBar(
                ...
                actions: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      context.read<TableCubit>().updateAttendance(widget.groupId,month, cellValues,state.cellValues,daysOnMonth.length);
                    },
                    color: whiteColor,
                  ),
                  IconButton(
                                    ...
                                    (rowIndex) => DataRow(
                                      cells: [
                                        DataCell(
                                          GestureDetector(
                                            onDoubleTap: (){
                                              _showUpdateDialog(context, allData[rowIndex], screenW);
                                            },
                                            onLongPress: () {
                                        ...
                                        cells: List<DataCell>.generate(
                                          ...
                                          (cellIndex) {
                                            ...
                                            return DataCell(
                                              GestureDetector(
                                                onLongPress: () {
                                                   _showcommentDialog(context,cellValues[rowIndex][cellIndex].key);
                                                },
                                                onTap: () {
                                                  setState(() {
